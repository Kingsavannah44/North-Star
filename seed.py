...
def seed():
    ...
    try:
        ...
        orders = [
            Order(order_number="NS1001", customer_id=customers[0].id, status="Shipped",    tracking_number="TRK98231", estimated_delivery=date(2026, 8, 16)),
            Order(order_number="NS1002", customer_id=customers[1].id, status="Processing", tracking_number=None,       estimated_delivery=date(2026, 8, 20)),
            Order(order_number="NS1003", customer_id=customers[2].id, status="Delivered",  tracking_number="TRK11245", estimated_delivery=date(2026, 8, 5)),
            Order(order_number="NS1004", customer_id=customers[3].id, status="Cancelled",  tracking_number=None,       estimated_delivery=None),
            Order(order_number="NS1005", customer_id=customers[4].id, status="Shipped",    tracking_number="TRK44512", estimated_delivery=date(2026, 8, 18)),
            Order(order_number="NS1006", customer_id=customers[5].id, status="Processing", tracking_number=None,       estimated_delivery=date(2026, 8, 22)),
            Order(order_number="NS1007", customer_id=customers[6].id, status="Delivered",  tracking_number="TRK77893", estimated_delivery=date(2026, 8, 1)),
            Order(order_number="NS1008", customer_id=customers[7].id, status="Shipped",    tracking_number="TRK23456", estimated_delivery=date(2026, 8, 19)),
            Order(order_number="NS1009", customer_id=customers[8].id, status="Processing", tracking_number=None,       estimated_delivery=date(2026, 8, 25)),
            Order(order_number="NS1010", customer_id=customers[9].id, status="Delivered",  tracking_number="TRK99001", estimated_delivery=date(2026, 8, 7)),
            Order(order_number="NS1011", customer_id=customers[0].id, status="Cancelled",  tracking_number=None,       estimated_delivery=None),
            Order(order_number="NS1012", customer_id=customers[1].id, status="Shipped",    tracking_number="TRK55678", estimated_delivery=date(2026, 8, 17)),
            Order(order_number="NS1013", customer_id=customers[2].id, status="Processing", tracking_number=None,       estimated_delivery=date(2026, 8, 24)),
            Order(order_number="NS1014", customer_id=customers[3].id, status="Delivered",  tracking_number="TRK34521", estimated_delivery=date(2026, 8, 3)),
            Order(order_number="NS1015", customer_id=customers[4].id, status="Shipped",    tracking_number="TRK66432", estimated_delivery=date(2026, 8, 21)),
        ]
        db.add_all(orders)
        db.commit()
